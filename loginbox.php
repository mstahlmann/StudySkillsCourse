    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body" style="padding:40px 50px;">
          <form role="form" action="coursestart.php" method="post">
            ...
            <div class="checkbox">
              ...
              <button type="submit" class="btn btn-success btn-block"style="background-color:#A4CD40;"><span class="glyphicon glyphicon-off"></span> Login</button>
          </form>
        </div>
