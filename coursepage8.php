...
<div class="container" style="height:1200px">
  <h2>Lesson 8 The Cornell Method</h2>
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#pdf1">Cornell Method Layout</a></li>
    <li><a data-toggle="tab" href="#pdf2">Cornell Method Example</a></li>
  </ul>
  ...
  <div class="tab-content" style="padding-bottom:50px;">
      ...
      <div id="video" class="tab-pane fade in active">
        ...
        <div class="embed-responsive embed-responsive-4by3">
          <video width="320" height="240" controls>
            <source src="video/Lesson8.mp4" type="video/mp4">
           </video>
        </div>
      </div>
      <div id="video2" class="tab-pane fade">
        ...
        <div class="embed-responsive embed-responsive-4by3">
          <video width="320" height="240" controls>
            <source src="video/Lesson8AAV.mp4" type="video/mp4">
           </video>
        </div>
      </div>
    ...
    <div id="pa" class="tab-pane fade">
      <h3>Processing Assignment</h3>
        ...
        <br>1. Finish processing your notes from the Lesson 8 Mock Lecture using the Cornell Method.
        <br>2. Take notes on the Lesson 8 Application Assignment Video using telegraphic sentences and shortcuts, and then process these notes using the Cornell Method.
        </p>
    </div>
    
    <div id="pdf1" class="tab-pane fade">
      <h3>Cornell Method Layout</h3>
      <div>
        <div class='embed-responsive' style='padding-bottom:150%'>
          <object data="pdf/CornellMethodLayout.pdf" type='application/pdf' width='100%' height='100%'></object>
        </div>
      </div>
    </div>
    <div id="pdf2" class="tab-pane fade">
      <h3>Cornell Method Example</h3>
      <div>
        <div class='embed-responsive' style='padding-bottom:150%'>
          <object data="pdf/CornellMethodExample.pdf" type='application/pdf' width='100%' height='100%'></object>
        </div>
      </div>
    </div>
  </div>
